<template>
  <div class="w-full h-full p-10">
    <div class="w-full h-[60px] text-primary text-3xl">Ant组件</div>
      ...
      <a-col flex="auto">
        <a-space direction="vertical" style="width: 100%" :size="0">
          ...
          <SplitSpace>
            ...
            <a-button type="primary-line">Dashed</a-button>
            <a-button type="success">Primary</a-button>
            <a-button type="success-line">Dashed</a-button>
            <a-button type="warning">Primary</a-button>
            <a-button type="warning-line">Dashed</a-button>
            <a-button type="alarm">Primary</a-button>
            <a-button type="alarm-line">Dashed</a-button>
            <a-button danger type="danger">Primary</a-button>
            <a-button danger type="danger-line">Dashed</a-button>
          </SplitSpace>
  ...
  components: {
    ...
    SplitSpace: (props, { slots }) =>
      h(
        Space,
        { size: 4, ...props },
        { ...slots, split: () => h(Divider, { type: "vertical" }) }
      ),
  },
  setup() {
    const inputProps = {
